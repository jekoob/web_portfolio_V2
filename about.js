...
function currentContent(anchoer){
    for(i=3;i<6;i++){
    document.getElementsByTagName("li")[i].style.backgroundColor="rgba(100, 200, 300, 0.5)";
...
function toggleUp(){
    ...
    document.getElementsByClassName("proImg")[0].style.display="none";
...
function toggleDown(){
    ...
    setTimeout(function(){
        ...
        document.getElementsByClassName("proImg")[0].style.display="block";
